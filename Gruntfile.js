module.exports = function(grunt) {
	...
	target: {
		files:{
			'dist/css/min.css' : [,'src/components/foundation/css/foundation.css','src/components/jquery.ambiance/assets/css/jquery/ambiance.jss','src/components/jquery-ui/themes/base/jquery-ui.css','src/components/jqueryui-timepicker-addon/src/jquery-ui-timepicker-addon.css','src/css/style.css']
		}
	}  
     }
    });
